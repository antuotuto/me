...
<div id="app">
  <div class="resume">
    <div class="left">
      ...
      <ContextList title="联系方式" :icon="require('@/assets/title-contact.png')">
        <ListItemInfo title="17610705501" :image="require('@/assets/contact-phone.png')" slot="listItem">
        </ListItemInfo>
        <ListItemInfo title="675988829@qq.com" :image="require('@/assets/contact-mail.png')" slot="listItem">
        </ListItemInfo>
        <ListItemInfo title="antuotuo2016" :image="require('@/assets/social-wechat.png')" slot="listItem">
        </ListItemInfo>
        <ListItemInfo title="675988829" :image="require('@/assets/social-qq.png')" slot="listItem">
        </ListItemInfo>
      </ContextList>
      <ContextList title="社交网站" :icon="require('@/assets/title-contact.png')">
        <ListItemInfo title="https://github.com/antuotuto" :image="require('@/assets/social-github.png')" slot="listItem">
        </ListItemInfo>
      </ContextList>
    </div>
    <div class="right">
  ...
  <button class="sap" @click="saveAsImage">保存为图片</button>
  <div class="footer">
    <a href="https://github.com/antuotuto" target="_blank">
        <img src="./assets/social-github.png" height="36" width="36" alt="">
      </a> Designed by <a href="https://github.com/antuotuto">王安安</a>
  </div>
</div>
</template>
