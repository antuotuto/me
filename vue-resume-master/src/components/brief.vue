<template>
  <div class="brief">
    <div class="avatar">
      <EditImage :src="require('@/assets/an.jpg')" width="212" height="212" :isCircle="true" class="img"></EditImage>
      <div class="name" contenteditable="true">王 安</div>
      <div class="job" contenteditable="true">Web前端工程师</div>
      <div class="location">
        <img src="../assets/location.png"  alt="">
        <div class="location-name" contenteditable="true">湖南省, 岳阳市</div>
      </div>
    </div>
    <div class="info">
      <ul>
